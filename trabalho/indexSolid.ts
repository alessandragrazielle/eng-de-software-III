...
interface IAutenticacao{
    autentica(user: string, senha:number): void;
}
...
//srp
class Validacao implements IValidacao {
    validarValor(valor: number): boolean {
...
class User implements IUser{
    ...
    excluir(nomeUsuario: string, senha: number): void {
        ...
        const autenticacao = new Autenticacao(this._usuarios[indice]);
        autenticacao.autentica(nomeUsuario, senha);
